...
//#include <tchar.h>
//#include "Knapsack.h"
//#define NN 18  //количество предметов Ц 18 шт
//int main(int argc, _TCHAR* argv[])
//{
//	setlocale(LC_ALL, "rus");
//	int V = 300;  // вместимость рюкзака 300 кг
//	auxil::start();
//	int v[NN], c[NN];
//		for (int i = 0; i < NN; i++) //заполнение рандомными числами 
//		{
//			v[i] = auxil::iget(10, 300); //веса предметов 10 Ц 300 кг
//			c[i] = auxil::iget(5, 55); //стоимость предметов 5 Ц 55 у.е
//		}	
...
//	std::cout << std::endl << "- оптимальна€ стоимость рюкзака: " << maxcc;
...
int main(int argc, _TCHAR* argv[])
{
	...
	std::cout << std::endl << "    предметов          вычислени€  ";
	for (int i = 12; i <= NN; i++)
	{
		t1 = clock();
